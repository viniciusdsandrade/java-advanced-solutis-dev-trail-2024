...
public enum TypeProductFrameEnum implements IFrameEnum {

	ID("_id", 12, IFrameEnum.LTE, true, "lbl.id", true, null, null, null, null, null, null), 
	...
	public static String TYPE_CLOTH = "{\""+ID+"\": 1, \""+NAME+"\": \"Roupas\"}";
	
	private TypeProductFrameEnum(String name, Integer length, String operLength, Boolean required, String label,
	...
	public static TypeProductFrameEnum findByName(String name) {
		for (TypeProductFrameEnum en : TypeProductFrameEnum.values()) {
