...
public enum AddressFilterFrameEnum implements IFrameEnum {

	USER("idUser", 12, IFrameEnum.LTE, true, "lbl.user", true, null, null, null, null, null, null),
	LOCATION("location", null, null, false, "lbl.location", null, null, null, null, LocationFrameEnum.values(), null, null),
	;
	...
	private AddressFilterFrameEnum(String name, Integer length, String operLength, Boolean required, String label,
	...
	public static AddressFilterFrameEnum findByName(String name) {
		for (AddressFilterFrameEnum en : AddressFilterFrameEnum.values()) {
