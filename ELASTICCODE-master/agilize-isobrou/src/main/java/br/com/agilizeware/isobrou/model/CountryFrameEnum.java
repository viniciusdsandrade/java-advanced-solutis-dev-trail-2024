...
public enum CountryFrameEnum implements IFrameEnum {
	...
	private CountryFrameEnum(String name, Integer length, String operLength, Boolean required, String label,
	...
	public static CountryFrameEnum findByName(String name) {
		for (CountryFrameEnum en : CountryFrameEnum.values()) {
