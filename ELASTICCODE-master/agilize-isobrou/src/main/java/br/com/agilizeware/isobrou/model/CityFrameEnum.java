...
public enum CityFrameEnum implements IFrameEnum {
	...
	UF("state", null, null, true, "lbl.uf", false, null, null, null, UFFrameEnum.values(), null, null),
	;
	...
	private CityFrameEnum(String name, Integer length, String operLength, Boolean required, String label,
	...
	public static CityFrameEnum findByName(String name) {
		for (CityFrameEnum en : CityFrameEnum.values()) {
