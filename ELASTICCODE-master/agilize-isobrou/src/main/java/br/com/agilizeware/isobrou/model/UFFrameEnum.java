...
public enum UFFrameEnum  implements IFrameEnum {

	ID("id", 12, IFrameEnum.LTE, true, "lbl.id", true, null, null, null, null, null, null), 
	NAME("name", 120, IFrameEnum.LTE, true, "lbl.name", false, null, null, null, null, null, null), 
	INITIALS("initials", 2, IFrameEnum.LTE, true, "lbl.initials", false, null, null, null, null, null, null),
	COUNTRY("country", null, null, true, "lbl.country", false, null, null, null, CountryFrameEnum.values(), null, null),
	;
	...
	private UFFrameEnum(String name, Integer length, String operLength, Boolean required, String label,
	...
	public static UFFrameEnum findByName(String name) {
		for (UFFrameEnum en : UFFrameEnum.values()) {
