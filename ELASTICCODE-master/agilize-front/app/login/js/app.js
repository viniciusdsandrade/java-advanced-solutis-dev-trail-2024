(function () {
    ...
    var app = angular.module('app', ['ngRoute', 'services.i18nNotifications', 'services.localizedMessages', 'authorizationModule', 'angularUUID2',
    	'services.propriedades', 'services.httpRequestTracker', 'restResource', 'msgbox', 'localStorage', 'ui.mask', 'ngCpfCnpj', 'satellizer',
    	'LoginModule']);
    ...
    app.constant('APP_CONFIG', {
    ...
    }).config(function ($httpProvider, $routeProvider, APP_CONFIG, $authProvider) {
	    ...
	    $authProvider.google({
	    	clientId: '630759010849-dakod8a7rf5t4v76eq05r3dstp4cvtic'
	    	//redirectUri: 'http://localhost:3000/auth/google'
	    	//redirectUri: APP_CONFIG.hostBack + '/agilize/login/google'
	    });
