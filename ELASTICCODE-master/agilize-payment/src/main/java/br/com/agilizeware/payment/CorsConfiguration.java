...
@Configuration
//@EnableWebMvc
@ComponentScan( basePackages = { "br.com.agilizeware.payment.repository.*" })
@EnableJpaRepositories(basePackages = {"br.com.agilizeware.payment.repository"})
...
public class CorsConfiguration extends WebMvcConfigurerAdapter {
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		registry.addMapping("/**").allowedOrigins(urlEnabled.split(",")).allowedMethods("*").allowCredentials(true);
	}
