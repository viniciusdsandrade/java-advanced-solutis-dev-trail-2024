...
public class Payment implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6127532111970650832L;
	...
	public CreditCard debitCard(String securityCode, String brand) {
		setType(Type.DebitCard);
		setDebitCard(new CreditCard(securityCode, brand));
		return getDebitCard();
	}

	public CreditCard getDebitCard() {
		return debitCard;
	}

	public void setDebitCard(CreditCard debitCard) {
