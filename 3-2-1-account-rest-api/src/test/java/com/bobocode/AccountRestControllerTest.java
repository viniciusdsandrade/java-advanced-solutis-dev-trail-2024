...
class AccountRestControllerTest {
    ...
    void getById() throws Exception {
        ...
        mockMvc.perform(get(format("/accounts/%d", account.getId())))
                .andExpect(status().isOk())
    ...
    void updateAccount() throws Exception {
        ...
        mockMvc.perform(put(format("/accounts/%d", account.getId())).contentType(APPLICATION_JSON)
                        .content(format("{\"id\":\"%d\", \"firstName\":\"Johnny\", \"lastName\":\"Boy\", \"email\":\"johnny.boy@gmail.com\"}", account.getId())))
    ...
    void removeAccount() throws Exception {
        ...
        mockMvc.perform(delete(format("/accounts/%d", account.getId())))
                .andExpect(status().isNoContent());
    }
}
